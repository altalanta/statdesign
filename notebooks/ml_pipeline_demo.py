...
def evaluate_model_performance():
    ...
    cv_scores_orig = cross_val_score(rf_original, X_orig_train_scaled, y_train, cv=5, scoring='roc_auc')
    cv_scores_comb = cross_val_score(rf_combined, X_comb_train_scaled, y_train, cv=5, scoring='roc_auc')
    ...
    print(f"Original Features Only:")
...
if __name__ == "__main__":
    ...
    print(f"This demonstrates the value of network context for drug target prioritization.")